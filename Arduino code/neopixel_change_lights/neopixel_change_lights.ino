...
void loop() {
  knightRider(3, 5, 4, 0xFF1000); // Cycles, Speed, Width, RGB Color (original orange-red)
  knightRider(3, 5, 3, 0xFF00FF); // Cycles, Speed, Width, RGB Color (purple)
  knightRider(3, 5, 2, 0x0000FF); // Cycles, Speed, Width, RGB Color (blue)
  knightRider(3, 1, 5, 0xFF0000); // Cycles, Speed, Width, RGB Color (red)
  knightRider(3, 1, 6, 0x00FF00); // Cycles, Speed, Width, RGB Color (green)
  knightRider(3, 1, 7, 0xFFFF00); // Cycles, Speed, Width, RGB Color (yellow)
  knightRider(3, 1, 8, 0x00FFFF); // Cycles, Speed, Width, RGB Color (cyan)
  knightRider(3, 1, 2, 0xFFFFFF); // Cycles, Speed, Width, RGB Color (white)
  clearStrip();
  delay(20);
